...
import { ArrowUp, Sun, Moon, Sparkles, Flame } from "lucide-react";
...
export default function Footer() {
  ...
  return (
    <footer className="bg-brand-black text-white py-16 border-t border-white/5 relative overflow-hidden text-left font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-12 border-b border-white/10 items-start">
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <p className="text-zinc-500 text-xs font-light leading-relaxed max-w-xs font-sans">
                ...
                {navLinks.slice(0, 3).map((link) => (
                  <li key={link.label}>
                    <a
                      ...
                      className="text-xs text-zinc-500 hover:text-[#FF5A1F] transition-all tracking-wide font-sans"
                    >
                      {link.label}
                    </a>
                  </li>
          ...
          <div className="md:col-span-3 space-y-4">
            ...
            <div className="p-4 bg-[#111] border border-white/5 rounded-xl space-y-2.5 text-[10px] font-mono text-zinc-500 leading-relaxed">
              ...
              <p className="font-mono">Node compiled server execution routes proxying Gemini securely.</p>
              <p className="text-[#FF5A1F] tracking-widest font-extrabold uppercase mt-0.5 font-mono">
                SSL_ENCRYPTED_OK
              </p>
            </div>
          </div>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-zinc-500">
          ...
          <div className="flex items-center space-x-4">
            ...
            <span>•</span>
            <a href="mailto:01harmandeep@gmail.com" className="hover:text-white transition-colors font-mono">
              Direct Mail
            </a>
            <span>•</span>
            ...
            <button
              onClick={scrollToTop}
              className="p-1.5 bg-zinc-800 hover:bg-[#FF5A1F] hover:text-white text-zinc-200 rounded transition-colors cursor-pointer"
