...
import { X, Printer, Mail, Phone, MapPin, Linkedin, Github, Check, Copy } from "lucide-react";
...
export default function ResumeModal({ isOpen, onClose }: ResumeModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4">
      ...
      {/* Modal Hub */}
      <div className="relative bg-brand-cream dark:bg-[#0E0E0E] border border-zinc-200 dark:border-white/10 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col shadow-2xl z-10 text-left animate-fade-in">
