...
const AI_TOOLS_DATA: AiTool[] = [
  {
    ...
    avatarUrl: "https://i.ibb.co/3mS6g1Qn/google-ai-studio-logo.png",
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                ...
                <div className="md:col-span-7 bg-[#151515] text-zinc-300 font-mono text-[11px] p-4 rounded-xl overflow-x-auto border border-white/5 text-left shadow-inner select-all relative">
                  ...
                  <pre className="whitespace-pre-wrap leading-tight font-mono">{selectedTool.usageSnippet}</pre>
                </div>
                ...
                <div className="md:col-span-5 bg-brand-cream/60 dark:bg-brand-black/40 border border-zinc-200/50 dark:border-white/5 text-zinc-600 dark:text-zinc-400 font-mono text-[10px] p-4 rounded-xl flex flex-col justify-between text-left min-h-[140px]">
                  <div>
                    <div className="text-[9px] text-zinc-400 uppercase tracking-widest font-bold mb-1.5 font-mono">TERMINAL LIVE OUTPUT</div>
                    <p className="whitespace-pre-wrap text-zinc-700 dark:text-zinc-300 leading-tight font-mono">
                      {simOutput ? simOutput : "Click 'Simulate Script' to execute API integration sequence..."}
                    </p>
                  </div>
                  {isRunningSim && (
                    <div className="flex items-center space-x-2 text-brand-orange animate-pulse font-bold mt-2 font-mono">
