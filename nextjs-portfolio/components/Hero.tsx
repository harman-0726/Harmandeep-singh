...
export default function Hero({ onProjectsClick, onContactClick }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[25%] left-[-10%] w-[350px] h-[350px] rounded-full bg-brand-orange/10 blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="md:col-span-7 space-y-8 text-left">
            ...
            {/* Tagline Badge */}
            <div className="inline-flex items-center space-x-2 bg-brand-orange/10 border border-brand-orange/20 rounded-full px-3.5 py-1.5 transition-all text-brand-orange">
